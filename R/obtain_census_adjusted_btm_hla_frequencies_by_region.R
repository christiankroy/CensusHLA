...
obtain_census_adjusted_nmdp_hla_frequencies_by_region <- function(in_region,
                                                                 region_level = "state"){
  ...
  if (!(in_region %in% c("us","all states", valid_state_names)))
  {
    ...
    us_population_race_code_percentages <-
      us_pop_multirace_adjusted_in_nmdp_codes_by_region(in_region, census_region_level = region_level) |>

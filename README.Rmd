...
[See Github pages (pkgdown) Documentation](https://affini-t-tx.github.io/CensusHLA/)
...
- Import and process HLA frequency data from external sources, specifically Gragert et al. (2013) as hosted by the NMDP.
- Import and process spatial data from the US Census Bureau, including shapefiles and demographic data.
...
To access US Census data, you need an API key. Follow the instructions [here](https://www.hrecht.com/censusapi/articles/getting-started.html#api-key-setup) to obtain your key. Add the key to your `~/.Renviron` file:
